...
const CreatePost = () => {
    ...
    const POST_CATEGORIES = ["Uncategorized","Healthy", "FastFood", "Vegan", "GlutenFree", "Vegetarian"]
        ...
        <div className="create-post">
            <div className="container">
                ...
                <form onSubmit={createPost} className='form create-post__form' encType="multipart/form-data">
                    ...
                    <ReactQuill modules={modules} formats={formats} value={description} onChange={setDescription} className="editor" ></ReactQuill>
